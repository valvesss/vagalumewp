...
print("Set a number to retrieve musics most acessed!", connection.get_n_music_acessed(int(input("Number: "))))
...
print("\nArtist {} albums most frequent word : {}".format(name.title(),connection.get_frequent_words()))
